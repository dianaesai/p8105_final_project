...
We can see from this model that there is no statistically significant association between length of lockdowns and excess deaths not realted to COVID-19. These results undermine the notion that "lockdowns kill people" that many persons assert. 

### Well, did prevention methods even help mitigate excess COVID-19 deaths? 
...
prevent_map1 = plot_usmap(data = states_df, values = "length", color = "black") + 
  ...
  labs(title = "Length of States' Stay-at-Home Orders")
...
Neither mask mandates nor travel restrictions had significant relationships with the number of above average deaths not related to COVID-19.  
...
states_final = right_join(states, home_deaths) %>% 
...
No. We do not see any significant relationship between how long state residents were asked to shelter-in-place and the number of non-COVID-19 deahts at home per 100,000 persons.  
